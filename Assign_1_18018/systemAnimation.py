...
class massSpringAnimation:
    ...
    def draw_wall(self, z):
        ...
        corner = (x, y)
        if self.flag_init == True:
            self.handle.append(mpatches.Rectangle(
                corner, P.w, P.h, fc='blue', ec='black'))
    ...
    def draw_box(self, z):
        ...
        if self.flag_init == True:
            self.handle.append(
                mpatches.Rectangle(corner, P.ww, P.hh, fc='green', ec='black'))
    ...
    def draw_spring(self, z):
        ...
        if self.flag_init == True:
            self.handle.append(
                mpatches.Rectangle(corner, 1.0-P.w-P.ww/2.0, 0.001, fc='brown', ec='black'))
    ...
    def draw_damper(self, z):
        ...
        if self.flag_init == True:
            self.handle.append(
                mpatches.Rectangle(corner, 1.0-P.w-P.ww/2.0, 0.01, fc='grey', ec='black'))
